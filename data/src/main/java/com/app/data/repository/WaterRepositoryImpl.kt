...
class WaterRepositoryImpl @Inject constructor(
    ...
    override suspend fun saveWithAchievement(uid: String, waterLog: WaterLog) {
        ...
        firestore.runTransaction { transaction ->
            ...
            val reachedGoalFirstTime = waterLog.cups >= dailyGoal && goalAchievedDate != waterLog.date
    ...
    private fun handleStreakBadges(
        ...
        when (newString) {
            7 -> createBadge(transaction, userRef, BadgeType.WEEK_7DAYS, "7일 연속 달성", "7일 동안 꾸준히 물을 마셨습니다!", date)
            30 -> createBadge(transaction, userRef, BadgeType.MONTH_30DAYS, "30일 연속 달성", "한달 동안 꾸준히 물을 마셨습니다!", date)
            180 -> createBadge(transaction, userRef, BadgeType.KING_6MONTHS, "6개월 꾸준함의 왕", "6개월 동안 꾸준히 물을 섭취했습니다!", date)
        }
    }
